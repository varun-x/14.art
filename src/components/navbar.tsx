...
import { MessageCircle, MessageCirclePlus, Moon, Send, SendHorizonal } from "lucide-react"
...
export const AppNavBar = ({ className }: { className?: string }) => {
  ...
  return (
    <motion.div ref={ref} className={cn("sticky inset-x-0 top-1 z-40 w-full  bg-[#f6f1e8]", className)}>
      <motion.div
        animate={{
          boxShadow: visible ? "0 0 6px rgba(34, 42, 53, 0.04), 0 1px 2px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(34, 42, 53, 0.03)" : "none",
          width: visible ? "80%" : "90%",
          y: visible ? 12 : 10,
        }}
        transition={{
